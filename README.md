...
To illustrate the performance of our models, here are some sample outputs from each experiment:

### Base Model (No Attention)

<p align="center">
  <img src="Figures/base_output.png" width="400"/>
  <br/>
  <em>Fig: Captions generated by the base model without attention mechanisms.</em>
</p>

### Soft Attention Model

<p align="center">
  <img src="Figures/soft_output.png" width="400"/>
  <br/>
  <em>Fig: Captions generated using soft attention. The model focuses on all parts of the image with varying emphasis.</em>
</p>

### Hard Attention Model

<p align="center">
  <img src="Figures/hard_output.png" width="400"/>
  <br/>
  <em>Fig: Captions generated using hard attention. The model stochastically selects specific image regions at each step.</em>
</p>

These visual results show that incorporating attention mechanisms improves the contextual relevance and detail of the generated captions, with soft attention generally providing smoother and more interpretable outputs.
...
- Acknowledge the contributions of the PyTorch and NLTK communities for providing robust libraries.
